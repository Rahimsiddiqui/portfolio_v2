...
import { ToastProvider, useToast } from "@/components/alert-toast";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Message sent",
        description:
          "Thanks — I appreciate you reaching out. I'll get back to you soon.",
        variant: "default",
      });
    } catch (error) {
    ...
    >
      ...
      <button type="submit">
        ...
        >
          ...
          <div className={`arrow-wrapper ${loading ? "hidden" : "flex"}`}>
            <Image
